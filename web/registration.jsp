                     ...
                     <form action="generalcode/regcode.jsp" method="post">
                        ...
                        <table style="margin:0 auto;width:70%;font-family:consolas;/*box-shadow: 5px 5px 5px black;*/ "cellspacing="10px">
                            <tr>
                                ...
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">Enter Company Name</td>
                                <td>
                                    <input type="text" name="companyname" required style="background-color:lightseagreen;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:100%;font-family: consolas;font-size:20px;color: white;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">Address</td>
                                <td>
                                    <textarea name="address" required style="resize: none;color: white;background-color:lightseagreen;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:98.4%;font-family: consolas;font-size:20px;"></textarea>
                                </td>
                            </tr>
                            
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">Expertise Area</td>
                                <td>
                                    <textarea name="expertisearea" required style="resize: none;color: white;background-color:lightseagreen;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:98.4%;font-family: consolas;font-size:20px;"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">Concern Person Name</td>
                                <td>
                                    <input type="text" name="personname" required style="background-color:lightseagreen;color: white;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:100%;font-family: consolas;font-size:20px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">Contact No.</td>
                                <td>
                                    <input type="text" name="contactno" required style="background-color:lightseagreen;color: white;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:100%;font-family: consolas;font-size:20px;"/> 
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">TIN No.</td>
                                <td>
                                    <input type="text" name="tinno" required style="background-color:lightseagreen;color: white;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:100%;font-family: consolas;font-size:20px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 40px;width:50%;font-family: consolas;font-size:20px;">PAN No.</td>
                                <td>
                                    <input type="text" name="panno" required style="background-color:lightseagreen;color: white;outline:none;border:none;box-shadow:5px 2px 5px 5px black;height: 40px;width:100%;font-family: consolas;font-size:20px;"/> 
                                </td>
                            </tr>
                            <tr>
